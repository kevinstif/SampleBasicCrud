...
{
    public abstract class GeorWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GeorWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GeorWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GeorDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GeorDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GeorDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GeorDbContext, Task<T>> func)
        {
            T result;
